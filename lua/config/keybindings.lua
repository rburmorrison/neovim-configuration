...
vim.api.nvim_create_autocmd("LspAttach", {
  ...
  callback = function(ctx)
    ...
    vim.keymap.set("n", "<leader>la", function() MiniExtra.pickers.lsp({ scope = "references", }) end,
      { buffer = ctx.buf, desc = "Code actions picker", })
    ...
    vim.keymap.set("n", "<leader>li", vim.lsp.buf.implementation, { buffer = ctx.buf, desc = "Go to implementation", })

    vim.keymap.set("n", "<leader>lt", vim.lsp.buf.type_definition, { buffer = ctx.buf, desc = "Go to type definition", })
